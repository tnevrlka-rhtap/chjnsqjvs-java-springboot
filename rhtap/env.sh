...
export IMAGE_URL=${IMAGE_URL-quay.io/tnevrlka-rhtap/rhtap-qe-java-springboot:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/tnevrlka-rhtap/chjnsqjvs-java-springboot-gitops
